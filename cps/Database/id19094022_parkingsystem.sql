...
--
-- Host: localhost:3306
-- Generation Time: Jun 12, 2022 at 06:48 PM
...
--
-- Database: `id19094022_parkingsystem`
--
...
CREATE TABLE `users` (
  `Name` varchar(90) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `Password` varchar(90) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `Email` varchar(90) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `Phone no` varchar(90) NOT NULL,
...
INSERT INTO `users` (`Name`, `Password`, `Email`, `Phone no`, `Address`, `Date`) VALUES
('jatin', 'd9a9046d60f3ec4358ba9e9594d5f1a7', 'jatin@gail.com', '976665', 'karol bagh', '2022-06-12 16:44:05');
