<?php
    ...
    if(isset($_POST['change-password'])){
        ...
        $query=mysqli_query($con,"SELECT Name from users where `Name`='$name' and `Password`='$cpassword'");
        $row=mysqli_fetch_array($query);

        if($row>0){
            $ret=mysqli_query($con,"update users set Password='$newpassword' where Name='$name'");
		...
		<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						$msg</div>" ?> 
							...
							<form method="post" action="./pages/change_password.php">
